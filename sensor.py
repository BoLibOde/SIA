...
try:
    from sensirion_i2c_driver import I2cTransceiver
...
class SensorRunner:
    ...
    def _initialize_scd4x(self):
        ...
        try:
            ...
            self.scd4x = Scd4xI2cDevice(I2cTransceiver(1, 0x62))  # I2C bus 1, default address: 0x62
            _LOG.info("Attempting to initialize SCD4x sensor...")
